            ...
            child: Stack(
              children: [
                      ...
                      rateMyApp.init().then((_) {
                        rateMyApp.showRateDialog(
                          ...
                          dialogStyle: DialogStyle(
                            ...
                            messageStyle:
                                kGoogleFont.copyWith(color: Colors.red),
                ...
                Container(
                  alignment: Alignment.center,
                  margin:
                      EdgeInsets.fromLTRB(0, deviceHeight * 5.25 / 10, 8.0, 0),
                  child: ListTile(
                    title: Row(
                      mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                      children: [
